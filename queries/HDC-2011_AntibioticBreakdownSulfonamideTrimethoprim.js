/**
 * Query Title: HDC-2011
 * Query Type:  Ratio
 * Initiative:  Antibiotic Breakdown
 * Description: Sulfonamide and Trimethoprim over all antibiotics, back one year
 */
function map( patient ){
  ...
  var query = {
    ...
    medNum   : dictionary.meds.antibioticSulfonamideTrimethoprim,
    backYrs  : 1,
